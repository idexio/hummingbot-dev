...
API_BASE_URL = "https://api-sandbox-eth.idex.io"
WS_BASE_URL = "https://api-sandbox-eth.idex.io"
...
class IdexExchangeUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if API_MOCK_ENABLED:
            ...
            cls.web_app.add_host_to_mock(API_BASE_URL, ["/ping", "/time"])   # Check if any ignored paths are required
            cls.web_app.start()
            cls.ev_loop.run_until_complete(cls.web_app.wait_til_started())
            cls._patcher = mock.patch("aiohttp.client.URL")
            cls._url_mock = cls._patcher.start()
            cls._url_mock.side_effect = cls.web_app.reroute_local
            cls.web_app.update_response("get", API_BASE_URL, "/balances", FixtureIdex.BALANCES)
            cls.web_app.update_response("get", API_BASE_URL, "/exchange", FixtureIdex.TRADE_FEES)
            cls.web_app.update_response("get", API_BASE_URL, "/orders", FixtureIdex.ORDERS_STATUS)
